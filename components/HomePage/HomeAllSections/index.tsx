...
import {
  AllPageFragment,
  BlogInnerFragment,
  HomeAboutUsSectionFragment,
  HomeBlogSectionFragment,
  HomeContactUsSectionFragment,
  HomeFragment,
  HomeHeroSectionFragment,
  HomeOurProsSectionFragment,
  HomeServicesSectionFragment,
  HomeVideoSectionFragment,
...
const HomeAllSections = ({ block, ...props }) => {
  let Component:
    | React.FC<{ block: HomeHeroSectionFragment }>
    | React.FC<{ block: HomeServicesSectionFragment }>
    | React.FC<{ block: HomeContactUsSectionFragment }>
    | React.FC<{ block: WorkSectionFragment }>
    | React.FC<{ block: HomeOurProsSectionFragment }>
    | React.FC<{ block: SolutionSectionFragment }>
    | React.FC<{ block: HomeAboutUsSectionFragment }>
    | React.FC<{ block: JamstackCteSectionFragment }>
    | React.FC<{
        block: HomeBlogSectionFragment;
        extraProps?: BlogInnerFragment[] | undefined;
      }>
    | React.FC<{ block: TestimonialsSectionFragment }>
    | React.FC<{ block: ReviewsSectionFragment }>
    | React.FC<{
        block: TitleHoverImageSectionFragment;
        services_card?: HomeFragment[] | AllPageFragment[] | undefined;
      }>
    | React.FC<{ block: HomeVideoSectionFragment }>
