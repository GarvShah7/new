...
const HomeHeroSection: React.FC<{ block: HomeHeroSectionFragment }> = ({
  block,
}) => {
  const {
    mainTitle,
    ...
    <section className={clsx("bannerSection ", sectionTheme ?? "bg-white")}>
      <div className="container max-w-[1440px] w-[90%] mx-auto">
        <div className="bannerContent pt-[8.375em] pb-[6.688em] max-w-[70%] font-Montserrat">
          ...
          <p className="home-banner--description max-w-[80%] text-[1.125em] leading-[1.7] font-[400] text-[#000000b3]">
            {description}
          </p>
