...
import {
  HeroSectionFragment,
  ImageWithTitleSectionFragment,
  HomeServicesSectionFragment,
  TitleSubtitleWithImageArraySectionFragment,
  ReviewsSectionFragment,
  RichTextFragment,
  ImageTitleDescriptionSectionFragment,
  RichTextIconSideImageSectionFragment,
  TitleSubtitleImageArraySideRichTextSectionFragment,
  TechStackSectionFragment,
  OurProcessSectionFragment,
  ChooseChSectionFragment,
  PricingSectionFragment,
  SolutionSectionFragment,
  TitleHoverImageSectionFragment,
  HomeFragment,
  AllPageFragment,
  TestimonialsSectionFragment,
  TitleWithSliderImageSectionFragment,
  HiringModelSectionFragment,
  ImageSideBySideTitleDescArraySectionFragment,
  TitleSubtitleTitleArraySectionFragment,
  HourlyDeveloperSectionFragment,
  FaqSectionFragment,
  ServiceDevelopmentSectionFragment,
  WorkSectionFragment,
  ServiceOurProcessSectionFragment,
  TeamPhotosSectionFragment,
  CompanyVisionsectionFragment,
  TitleWithFourImageSectionFragment,
  ContactInformationSectionFragment,
  ContactMapSectionFragment,
  JamstackCteSectionFragment,
  PortfolioInnerDevelopmentSectionFragment,
  ThemesSectionFragment,
  NextJsuSeCompaniesSectionFragment,
  WoocommerceBenefitSectionFragment,
  RichTextImageButtonSectionFragment,
  RichTextWithSideImageFragment,
  ImageArraySectionFragment,
  TitleDescriptionSideBySideBgImageSectionFragment,
  TitleDescriptionArrayWithSideTitleArraySectionFragment,
  ContactHeroSectionFragment,
  ContactMessageSectionFragment,
  EstimateProjectFormSectionFragment,
  FourOFourErrorSectionFragment,
  ThankyouFragment,
  TitledescfullimagesectionFragment,
  CompanyInfoSectionFragment,
  UiUxDevelopmentSectionFragment,
} from "../../../app/api/generated/graphql/graphql";

const Sections = ({ block, ...props }) => {
  let Component:
    | FC<{ block: HeroSectionFragment }>
    | FC<{ block: ImageWithTitleSectionFragment }>
    | FC<{ block: HomeServicesSectionFragment }>
    | FC<{ block: TitleSubtitleWithImageArraySectionFragment }>
    | FC<{ block: ReviewsSectionFragment }>
    | FC<{ block: RichTextFragment }>
    | FC<{ block: ImageTitleDescriptionSectionFragment }>
    | FC<{ block: RichTextIconSideImageSectionFragment }>
    | FC<{ block: TitleSubtitleImageArraySideRichTextSectionFragment }>
    | FC<{ block: TechStackSectionFragment }>
    | FC<{ block: OurProcessSectionFragment }>
    | FC<{ block: ChooseChSectionFragment }>
    | FC<{ block: PricingSectionFragment }>
    | FC<{ block: SolutionSectionFragment }>
    | FC<{
        block: TitleHoverImageSectionFragment;
        services_card?: HomeFragment[] | AllPageFragment[] | undefined;
      }>
    | FC<{ block: TestimonialsSectionFragment }>
    | FC<{ block: TitleWithSliderImageSectionFragment }>
    | FC<{ block: HiringModelSectionFragment }>
    | FC<{ block: ImageSideBySideTitleDescArraySectionFragment }>
    | FC<{ block: TitleSubtitleTitleArraySectionFragment }>
    | FC<{ block: HourlyDeveloperSectionFragment }>
    | FC<{ block: FaqSectionFragment }>
    | FC<{ block: ServiceDevelopmentSectionFragment }>
    | FC<{ block: WorkSectionFragment }>
    | FC<{ block: ServiceOurProcessSectionFragment }>
    | FC<{ block: TeamPhotosSectionFragment }>
    | FC<{ block: CompanyVisionsectionFragment }>
    | FC<{ block: TitleWithFourImageSectionFragment }>
    | FC<{ block: ContactInformationSectionFragment }>
    | FC<{ block: ContactMapSectionFragment }>
    | FC<{ block: JamstackCteSectionFragment }>
    | FC<{ block: PortfolioInnerDevelopmentSectionFragment }>
    | FC<{ block: ThemesSectionFragment }>
    | FC<{ block: NextJsuSeCompaniesSectionFragment }>
    | FC<{ block: WoocommerceBenefitSectionFragment }>
    | FC<{ block: RichTextImageButtonSectionFragment }>
    | FC<{ block: RichTextWithSideImageFragment }>
    | FC<{ block: ImageArraySectionFragment }>
    | FC<{ block: TitleDescriptionSideBySideBgImageSectionFragment }>
    | FC<{ block: TitleDescriptionArrayWithSideTitleArraySectionFragment }>
    | FC<{ block: ContactHeroSectionFragment }>
    | FC<{ block: ContactMessageSectionFragment }>
    | FC<{ block: EstimateProjectFormSectionFragment }>
    | FC<{ block: FourOFourErrorSectionFragment }>
    | FC<{ block: ThankyouFragment }>
    | FC<{ block: TitledescfullimagesectionFragment }>
    | FC<{ block: CompanyInfoSectionFragment }>
    | FC<{ block: UiUxDevelopmentSectionFragment }>
